...
void handleOption(string userOption)
{
    ...
    if(userOption == "V" || userOption == "v")
    {
      ...
      cout << "\nThe velocity is: " << speed << "/" << time << "=" << (speed/time) << endl;
    }
...
void showMenu()
{
  ...
  cout << "M: Caclulate Motion" << endl; 
  cout << "N: Newtons 2nd Law" << endl; 
  cout << "W: Calclate Weight on Earth" << endl;
  cout << "P: Calculate Momentum" << endl;
  cout << "E: Exit" << endl; 
  cout << "X: clear the screen" << endl; 
  cout << "1: calc velocity" << endl; 
}
//definintion 
